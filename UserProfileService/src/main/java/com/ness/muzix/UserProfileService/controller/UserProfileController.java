...
public class UserProfileController {
	...
	public ResponseEntity<UserProfile> getUserProfileByUsername(@PathVariable String username) throws UserProfileException {
		return new ResponseEntity<UserProfile>(userProfileService.getUserProfileByUsername(username),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<String> changePassword(@RequestBody UserProfileDto user) throws UserProfileException {
		return new ResponseEntity<String>(userProfileService.changePassword(user.getUsername(),user.getOldPassword(),user.getNewPassword()),
	...
	public ResponseEntity<String> forgetPassword(@RequestBody UserProfileDto user) throws UserProfileException {
		return new ResponseEntity<String>(userProfileService.forgetPassword(user.getUsername(),user.getNewPassword()),
				HttpStatus.RESET_CONTENT);
	}
